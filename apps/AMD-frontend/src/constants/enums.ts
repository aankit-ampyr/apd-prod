...
export enum APDAuditLogModules {
  ...
  SETTINGS = AuditLogModules.SETTINGS,
  ...
  INVOICE=AuditLogModules.INVOICE_ANALYSIS,
  EXECUTIVE_ANALYSIS=AuditLogModules.EXECUTIVE_ANALYSIS,
}
...
export enum APDAuditLogScenario {
  ...
  INVOICE_FILE_DOWNLOADED = AuditLogScenario.INVOICE_FILE_DOWNLOADED,
  SETTLEMENT_FILE_DOWNLOADED = AuditLogScenario.SETTLEMENT_FILE_DOWNLOADED,
  INVOICE_PREVIEW_DOWNLOADED = AuditLogScenario.INVOICE_PREVIEW_DOWNLOADED,
  INVOICE_ANALYSIS_VIEWED = AuditLogScenario.INVOICE_ANALYSIS_VIEWED,
  INVOICE_ANALYSIS_DATA_DOWNLOADED = AuditLogScenario.INVOICE_ANALYSIS_DATA_DOWNLOADED,
  SUMMARY_STATEMENT_UPLOADED = AuditLogScenario.SUMMARY_STATEMENT_UPLOADED,
  SUMMARY_STATEMENT_DOWNLOADED = AuditLogScenario.SUMMARY_STATEMENT_DOWNLOADED,
  SUMMARY_STATEMENT_DELETED = AuditLogScenario.SUMMARY_STATEMENT_DELETED,
  ADDED_COMMENT = AuditLogScenario.ADDED_COMMENT,
  UPDATED_COMMENT = AuditLogScenario.UPDATED_COMMENT,
  REMOVED_COMMENT = AuditLogScenario.REMOVED_COMMENT,
  REPLIED_TO_COMMENT = AuditLogScenario.REPLIED_TO_COMMENT,
  VIEWED_EXECUTIVE_ANALYSIS = AuditLogScenario.VIEWED_EXECUTIVE_ANALYSIS,
}
