...
import authReducer, {resetAuth, resetAuthWithReason, logoutSuccess} from './slice/authSlice';
...
const rootReducer = (state: ReturnType<typeof appReducer> | undefined, action: any) => {
    if (action.type === logoutSuccess.type || action.type === resetAuth.type || action.type === resetAuthWithReason.type) {
