...
const authSlice = createSlice({
  ...
  reducers: {
    ...
    // resend OTP
    resendOtpRequest(state, _action: PayloadAction<LoginRequest['payload']>) {
      // complete the implementation
    },
    resendOtpSuccess(state, action: PayloadAction<LoginRequest['response']>) {
      // complete the implementation
    },
    resendOtpFailure(state, action: PayloadAction<APIResponse>) {
      // complete the implementation
    },
