...
export async function updateSimulation(simulation_id: number, data: any) {
  return await createAxiosInstance({
...
export async function deleteSimulation(simulation_id: number) {
  return await createAxiosInstance({
    url: API.authUrls.projectSimulation.replace('{simulation_id}', String(simulation_id)),
    method: 'DELETE',
    headers: {...defaultHeaders, ...authHeaders},
...
export async function greenAnalysis(data: GreenAnalysis['payload']) {
  const {simulation_id, ...payload} = data;
  return await createAxiosInstance({
...
export async function greenAnalysisData(simulation_id: number) {
  return await createAxiosInstance({
    url: `${API.authUrls.greenAnalysis.replace('{simulation_id}', String(simulation_id))}`,
    method: 'GET',
    headers: {...defaultHeaders, ...authHeaders},
...
export async function runGreenAnalysis(simulation_id: number) {
  return await createAxiosInstance({
...
export async function stopGreenAnalysis(simulation_id: number) {
  return await createAxiosInstance({
...
export async function getGreenAnalysisResults(simulation_id: number, params: any) {
  return await createAxiosInstance({
...
export async function getGreenAnalysisExport(simulation_id: number, params: any) {
  const {fileName, ...rest} = params;
  await fetchAndDownloadBlob({
    url: `${API.authUrls.greenAnalysis.replace('{simulation_id}', String(simulation_id))}/results/export`,
    filename: fileName || `File.csv`,
    params: rest,
    paramsSerializer: (params: any) =>
      qs.stringify(params, {
...
export async function getGreenAnalysisProgress(simulation_id: number) {
  return await createAxiosInstance({
...
export async function detailedGreenAnalysis(data: DetailedGreenAnalysis['payload']) {
  const {simulation_id, ...payload} = data;
  return await createAxiosInstance({
...
export async function detailedGreenAnalysisData(simulation_id: number) {
  return await createAxiosInstance({
    url: `${API.authUrls.detailedGreenEnergy.replace('{simulation_id}', String(simulation_id))}`,
    method: 'GET',
    headers: {...defaultHeaders, ...authHeaders},
...
export async function runDetailedGreenAnalysis(simulation_id: number) {
  return await createAxiosInstance({
...
export async function getDetailedGreenAnalysisProgress(simulation_id: number) {
  return await createAxiosInstance({
...
export function getDetailedGreenAnalysisResult(simulation_id: number) {
  return createAxiosInstance({
...
export async function getGreenAnalysisHourlyExport(simulation_id: number, params: any) {
  const {fileName, ...rest} = params;
  await fetchAndDownloadBlob({
    url: `${API.authUrls.detailedGreenEnergy.replace('{simulation_id}', String(simulation_id))}/hourly/export`,
    filename: fileName || `File.csv`,
    params: rest,
  });
}

export async function getGreenAnalysisMonthlyExport(simulation_id: number, params: any) {
  const {fileName, ...rest} = params;
  await fetchAndDownloadBlob({
