...
import {Button, Icon, SelectInput, Text, TextInput} from '@/ui-kits';
...
export const DGSizing = ({onNextToRunSimulation}: DGSizingProps) => {
  ...
  const shouldShowCompletionSummary =
    !isSimulationRunning && !showCompletionProgress && !hasUserEditedSinceCompletion && (showCompletionSummary || isSimulationCompletedPersisted);
  ...
  const durationText = options.map(item => `${item?.duration} ${item?.detail}`).join(', ');
      ...
      <div className="bg-[#F7FDFC] p-4 mt-5 border-[1.4px] border-[#B6D7D3] rounded-lg w-full">
        ...
        <div className="flex flex-col xl:flex-row gap-4 mt-1">
          <div className="bg-white p-4 mt-5 border-[1.4px] border-border rounded-md w-full xl:w-[60%] tabular-nums">
            ...
            <div className="border-l-primary bg-primary-tint-2 border border-l-2 rounded-md border-border mt-4 p-4">
              <div className="flex items-center gap-3">
              ...
              <div className="flex flex-wrap lg:flex-nowrap gap-3 mt-3">
                {options.map(item => (
                  <div key={item.id} className="px-4 py-2 rounded-full bg-white whitespace-nowrap shadow-[0px_1px_1px_0px_#B0B0B017]!">
                    <Text variant="small" className="text-text-secondary!">
                      {item.duration} {item.detail}: {item.range}
                    </Text>
                  </div>
                ))}
              </div>
              <div className="flex items-center gap-3 mt-3">
                ...
                <Text variant={'small'} className="font-InterRegular! text-text-secondary!">
                  Duration classes: <span className="text-text-primary!">{durationText}</span>
                </Text>
              </div>
            </div>
          </div>
          ...
          <div className="bg-white p-4 mt-5 border-[1.4px] border-border rounded-md w-full xl:w-[60%] tabular-nums">
            ...
            {hasGenerator ? (
              ...
              <div className="bg-[#F8FCFF] border-[0.6px] border-blue/20 rounded-md flex items-center justify-center w-full p-7 mt-6">
                <div className="flex flex-col items-center text-center">
                  <Icon name="circle-info" className="text-blue! flex justify-center items-center size-4.75!" />{' '}
                  <Text variant={'small'} className="font-InterMedium! text-text-primary! mt-3">
                    DG Disabled
                  </Text>
                  <Text variant={'small'} className="font-InterRegular! text-text-secondary! mt-3">
                    Running Solar + BESS only configurations.
                  </Text>
                </div>
              </div>
            )}
        ...
        {hasConfigurationError ? (
          ...
          <>
            <div className="grid grid-cols-4 gap-6">
              <div>
                <Text variant="caption" className="font-InterMedium! text-text-secondary!">
                  BESS Sizes
                </Text>
                <Text variant="free" className="text-h2 font-semibold! text-text-primary!">
                  {simOverview.bessSizes}
                </Text>
              </div>
              ...
              <div>
                ...
                <Text variant="free" className="text-h2 font-semibold! text-teal!">
                  {simOverview.totalConfigs}
                </Text>
              </div>
            </div>
